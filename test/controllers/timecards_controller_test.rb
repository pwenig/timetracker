...
class TimecardsControllerTest < ActionController::TestCase
  ...
  test "should create timecard" do
    assert_difference('Timecard.count') do
      post :create, timecard: { notes: @timecard.notes, tasks: @timecard.tasks, time_in: @timecard.time_in, time_out: @timecard.time_out }
    end
  ...
  test "should update timecard" do
    patch :update, id: @timecard, timecard: { notes: @timecard.notes, tasks: @timecard.tasks, time_in: @timecard.time_in, time_out: @timecard.time_out }
    assert_redirected_to timecard_path(assigns(:timecard))
  end
